  ...
  director: [
    {
      ...
      items: [
        { label: "Tableau de bord", href: "/app", icon: Home },
        { label: "Rapports & Analyses", href: "/app/reports", icon: BarChart3 },
        { label: "Statistiques", href: "/app/stats", icon: FileSpreadsheet },
      ],
    },
    {
      label: "Vie scolaire",
  ...
  accountant: [
    {
      ...
      items: [
        { label: "Tableau de bord", href: "/app", icon: Home },
        { label: "Rapports financiers", href: "/app/reports", icon: BarChart3 },
        { label: "Frais & Paiements", href: "/app/fees", icon: CreditCard },
